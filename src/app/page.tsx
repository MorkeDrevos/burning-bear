...
<section id="wallets" className="scroll-mt-28 md:scroll-mt-32 lg:scroll-mt-36 mx-auto max-w-6xl px-4 py-10">
  ...
  address={BURN_WALLET}
  note="Tokens permanently and verifiably destroyed on-chain. Supply reduction that fuels $BBURN’s deflationary fire."
/>
    <WalletCard
...
/>
  ...
  note="Supports development, creators, and partnerships. Expanding reach while keeping the vision burning bright."
/>
  </div>
</section>
